...
const cases = [
  { beforeImg: "https://images.stockcake.com/public/6/3/c/63c0b3f3-1522-466f-b87a-da627eca6222_large/teeth-whitening-comparison-stockcake.jpg", afterImg: "https://images.stockcake.com/public/e/7/e/e7e5fb64-516a-47d5-b46b-2be729242653_large/smile-transformation-comparison-stockcake.jpg", title: "Hollywood Smile Makeover", subtitle: "Full smile transformation with porcelain veneers", category: "Cosmetic", duration: "2 Weeks" },
  { beforeImg: "https://images.stockcake.com/public/e/8/e/e8ea772a-e2b3-4062-b934-2c9626e041f8_large/tooth-restoration-comparison-stockcake.jpg", afterImg: "https://images.stockcake.com/public/4/f/9/4f9aed4f-d61e-4794-93ac-7617ccefb3bf_large/dental-transformation-success-stockcake.jpg", title: "Dental Implant Restoration", subtitle: "Natural-looking implants replacing missing teeth", category: "Implants", duration: "3 Months" },
  { beforeImg: "https://images.stockcake.com/public/0/9/d/09d91814-dc45-4197-bff4-bdd102ed9a64_large/teeth-whitening-transformation-stockcake.jpg", afterImg: "https://images.stockcake.com/public/5/b/d/5bd991ae-71de-4bff-833d-5ba3ca83f55b_large/teeth-whitening-comparison-stockcake.jpg", title: "Professional Teeth Whitening", subtitle: "8 shades brighter in a single session", category: "Whitening", duration: "1 Hour" },
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <ScrollReveal>
          <div ref={sliderRef} className="relative aspect-[21/9] rounded-[2rem] overflow-hidden cursor-col-resize select-none premium-shadow-xl" onMouseMove={(e) => handleMove(e.clientX)} onTouchMove={(e) => handleMove(e.touches[0].clientX)}>
            <div className="absolute inset-0"><Image src="https://images.stockcake.com/public/0/9/d/09d91814-dc45-4197-bff4-bdd102ed9a64_large/teeth-whitening-transformation-stockcake.jpg" alt="Before" fill className="object-cover" sizes="100vw" /></div>
            <div className="absolute inset-0" style={{ clipPath: `inset(0 0 0 ${sliderPos}%)` }}><Image src="https://images.stockcake.com/public/c/a/4/ca499c9b-6391-43d5-8890-793cf20c8837_large/dramatic-whitening-transformation-stockcake.jpg" alt="After" fill className="object-cover" sizes="100vw" /></div>
